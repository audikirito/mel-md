...
global.author = 'AudiModz' //ganti aja cuyyy
global.namebot = '​Audi-Md' //nama bot luh
global.wm = '© Audi-Md' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm = 'Audi-Md ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'AudiModz' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Audikirito-Md | AudiModz` //gantu aja
global.stickpack = 'Audi-Modz' //ganti 
global.stickauth = `© Audi-Md` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Audisw' //ganti 
global.nameown2 = 'Audisw' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
